...
const DisplayThreeSevenHangars = ({isLoggedIn, setIsLoggedIn}) => {
    ...
    const deleteButton=()=>{
        axios.delete(`http://localhost:8000/api/threeThroughSeven/${id}`, {withCredentials:true})
        .then((res)=>{
            console.log(res)
            console.log(res.data)
            
            navigate("/accountList/terminalLocations/threeSevenHangars")
        })
        .catch((err)=>{
            console.log(err)
        });
    ...
    // useEffect(()=>{axios.get(`http://localhost:8000/api/southTower/${id}`)
    ...
    useEffect(()=>{axios.get(`http://localhost:8000/api/threeThroughSeven/${id}`, {withCredentials:true})
        .then((res)=>{console.log(res.data)
            ...
            <thead>
                ...
                <tbody>
                    ...
                    <td>{oneInput.positivePrist}</td>
                     ...
                     <Link to={'/accountList/terminalLocations/threeSevenHangars'} className="homeBtn">Back</Link>
                     </td>
                    </tr>
                </tbody>
        </table>
...
export default DisplayThreeSevenHangars