...
const EditOneTwoHangars = ({isLoggedIn, setIsLoggedIn}) => {
    ...
    const updateOneTwoHangars = (e) =>{
        e.preventDefault()
        axios.put(`http://localhost:8000/api/oneTwo/${id}`, {
            area,
            locationOfPlane,
            tailNumber,
            fuelType,
  ...
  return (
    <div>
    { user ? (
<form onSubmit={updateOneTwoHangars}>
...
export default EditOneTwoHangars