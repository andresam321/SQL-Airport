...
const EditSvaHangar = ({isLoggedIn, setIsLoggedIn}) => {
    ...
    useEffect(()=>{axios.get(`http://localhost:8000/api/svaHangar/${id}`)
    .then((res)=>{
        console.log(res)
    ...
    const updateSvaHangar = (e) =>{
        e.preventDefault()
        axios.put(`http://localhost:8000/api/svaHangar/${id}`, {
            area,
            locationOfPlane,
            tailNumber,
            fuelType,
