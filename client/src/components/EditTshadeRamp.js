...
const EditTshadeRamp = ({isLoggedIn, setIsLoggedIn}) => {
    ...
    const updateTshadeRamp = (e) =>{
        e.preventDefault()
        axios.put(`http://localhost:8000/api/tShade/${id}`, {
            area,
            locationOfPlane,
            tailNumber,
            fuelType,
...
<form onSubmit={updateTshadeRamp}>
