...
const EditBayRamp = ({isLoggedIn, setIsLoggedIn}) => {
    ...
    const updateBayRamp = (e) =>{
        e.preventDefault()
        axios.put(`http://localhost:8000/api/bayRamp/${id}`, {
            area,
            locationOfPlane,
            tailNumber,
            fuelType,
