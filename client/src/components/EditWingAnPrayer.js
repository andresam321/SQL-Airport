...
const EditWingAnPrayer = ({isLoggedIn, setIsLoggedIn}) => {
    ...
    useEffect(()=>{axios.get(`http://localhost:8000/api/waap/${id}`, {withCredentials:true})
    .then((res)=>{
        console.log(res)
    ...
    const updateWingPrayer = (e) =>{
        e.preventDefault()
        axios.put(`http://localhost:8000/api/waap/${id}`, {
            area,
            locationOfPlane,
            tailNumber,
            fuelType,
 ...
 <form onSubmit={updateWingPrayer}>
...
export default EditWingAnPrayer