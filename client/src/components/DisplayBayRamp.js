...
const DisplayBayRamp = ({isLoggedIn, setIsLoggedIn}) => {
    ...
    const deleteButton=()=>{
        axios.delete(`http://localhost:8000/api/bayRamp/${id}`)
        .then((res)=>{
            console.log(res)
            console.log(res.data)
            
            navigate("/accountList/terminalLocations/bayRamp")
        })
        .catch((err)=>{
            console.log(err)
        });
    ...
    useEffect(()=>{axios.get(`http://localhost:8000/api/bayRamp/${id}`)
        .then((res)=>{console.log(res.data)
            ...
            <thead>
                ...
                <tbody>
                    ...
                    <td>{oneInput.positivePrist}</td>
                     ...
                     <Link to={'/accountList/terminalLocations/bayRamp'} className="homeBtn">Back</Link>
                     </td>
                    </tr>
                </tbody>
        </table>
