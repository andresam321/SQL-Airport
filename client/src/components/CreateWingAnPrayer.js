...
const CreateWingAnPrayer = ({isLoggedIn, setIsLoggedIn}) => {
    ...
    const submitHandler = (e) =>{
        e.preventDefault()
        axios.post('http://localhost:8000/api/waapHangar', {
            locationOfPlane,
            area,
            tailNumber,
            airplaneType,
...
<div className='display-flex3'>
        ...
        <div className="form-group row">
            ...
            <select value ={area} className="form-control" name="area" onChange={(e)=> setArea(e.target.value)}>
                <option>Area</option>
                <option value="Wing an A prayer">Wing an A Prayer</option>
...
export default CreateWingAnPrayer