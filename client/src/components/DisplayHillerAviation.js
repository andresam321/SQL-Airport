...
const DisplayHillerAviation = ({isLoggedIn, setIsLoggedIn}) => {
    ...
    const deleteButton=()=>{
        axios.delete(`http://localhost:8000/api/hillerAviation/${id}`)
        .then((res)=>{
            console.log(res)
            console.log(res.data)
            
            navigate("/accountList/towerLocations/hillerAviation")
        })
        .catch((err)=>{
            console.log(err)
        });
    ...
    useEffect(()=>{axios.get(`http://localhost:8000/api/hillerAviation/${id}`)
        .then((res)=>{console.log(res.data)
            ...
            <thead>
                ...
                <tbody>
                    ...
                    <td>{oneInput.positivePrist}</td>
                     ...
                     <Link to={'/accountList/towerLocations/hillerAviation'} className="homeBtn">Back</Link>
                     </td>
                    </tr>
                </tbody>
        </table>
...
export default DisplayHillerAviation