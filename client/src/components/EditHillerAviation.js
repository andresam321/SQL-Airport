...
const EditHillerAviation = ({isLoggedIn, setIsLoggedIn}) => {
    ...
    const updateHillerAviation = (e) =>{
        e.preventDefault()
        axios.put(`http://localhost:8000/api/hillerAviation/${id}`, {
            area,
            locationOfPlane,
            tailNumber,
            fuelType,
  ...
  return (
    <div>
    { user ? (
         <form onSubmit={updateHillerAviation}>
...
export default EditHillerAviation