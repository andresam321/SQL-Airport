...
const CreateAirRoger = ({isLoggedIn, setIsLoggedIn}) => {
...
const submitHandler = (e) =>{
    e.preventDefault()
    axios.post('http://localhost:8000/api/airRoger', {
        locationOfPlane,
        area,
        tailNumber,
        airplaneType,
      ...
      <form onSubmit={submitHandler}>
        ...
        <div className="form-group row">
            ...
            <select value ={area} className="form-control" name="area" onChange={(e)=> setArea(e.target.value)}>
                <option>Area</option>
                <option value="Air Roger">Air Roger</option>
            </select>
