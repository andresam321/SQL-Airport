...
const EditAirRoger = ({isLoggedIn, setIsLoggedIn}) => {
...
const updateRogerList = (e) =>{
    e.preventDefault()
    axios.put(`http://localhost:8000/api/airRoger/${id}`, {
        area,
        locationOfPlane,
        tailNumber,
        fuelType,
