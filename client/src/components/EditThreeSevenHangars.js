...
const EditThreeSevenHangars = ({isLoggedIn, setIsLoggedIn}) => {
  ...
  const updateThreeSevenHangars = (e) =>{
      e.preventDefault()
      axios.put(`http://localhost:8000/api/threeThroughSeven/${id}`, {
          area,
          locationOfPlane,
          tailNumber,
          fuelType,
...
<form onSubmit={updateThreeSevenHangars}>
...
export default EditThreeSevenHangars