...
const CreateTenElevenHangar = ({isLoggedIn, setIsLoggedIn}) => {
    ...
    const submitHandler = (e) =>{
        e.preventDefault()
        axios.post('http://localhost:8000/api/tteHangars', {
            locationOfPlane,
            area,
            tailNumber,
            airplaneType,
...
<div className='display-flex3'>
        ...
        <div className="form-group row">
            ...
            <select value ={area} className="form-control" name="area" onChange={(e)=> setArea(e.target.value)}>
                <option>Area</option>
                <option value="Hangar 10">Hangar 10</option>
                <option value="Hangar 11">Hangar 11</option>
...
export default CreateTenElevenHangar