...
const DisplayJatoAviation = ({isLoggedIn, setIsLoggedIn}) => {
  ...
  const deleteButton=()=>{
      axios.delete(`http://localhost:8000/api/jatoAviation/${id}`)
      .then((res)=>{
          console.log(res)
          console.log(res.data)
          
          navigate("/accountList/terminalLocations/jatoAviation")
      })
      .catch((err)=>{
          console.log(err)
      });
  ...
  useEffect(()=>{axios.get(`http://localhost:8000/api/jatoAviation/${id}`)
      .then((res)=>{console.log(res.data)
            ...
            <thead>
                ...
                <tbody>
                    ...
                    <td>{oneInput.positivePrist}</td>
                     ...
                     <Link to={'/accountList/terminalLocations/jatoAviation'} className="homeBtn">Back</Link>
                     </td>
                    </tr>
                </tbody>
        </table>
...
export default DisplayJatoAviation