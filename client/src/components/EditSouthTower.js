...
const EditSouthTower = ({isLoggedIn, setIsLoggedIn}) => {
    const{id} = useParams();
    ...
    const updateSouthTower = (e) =>{
        e.preventDefault()
        axios.put(`http://localhost:8000/api/southTower/${id}`, {
            area,
            locationOfPlane,
            tailNumber,
            fuelType,
  ...
  return (
    ...
    <form onSubmit={updateSouthTower}>
