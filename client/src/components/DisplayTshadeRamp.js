...
const DisplayTshadeRamp = ({isLoggedIn, setIsLoggedIn}) => {
    ...
    const deleteButton=()=>{
        axios.delete(`http://localhost:8000/api/tShade/${id}`)
        .then((res)=>{
            console.log(res)
            console.log(res.data)
            
            navigate("/accountList/terminalLocations/tShadeRamp")
    ...
    useEffect(()=>{axios.get(`http://localhost:8000/api/tShade/${id}`, {withCredentials:true})
        .then((res)=>{console.log(res.data)
            ...
            <thead>
                ...
                <tbody>
                    ...
                    <td>{oneInput.positivePrist}</td>
                     ...
                     <Link to={'/accountList/terminalLocations/tShadeRamp'} className="homeBtn">Back</Link>
                     </td>
                    </tr>
                </tbody>
        </table>
...
export default DisplayTshadeRamp