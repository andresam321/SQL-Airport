...
const EditJatoAviation = ({isLoggedIn, setIsLoggedIn}) => {
  ...
  const updateJatoAviation = (e) =>{
      e.preventDefault()
      axios.put(`http://localhost:8000/api/jatoAviation/${id}`, {
          area,
          locationOfPlane,
          tailNumber,
          fuelType,
  ...
  return (
    <div>
{ user ? (
<form onSubmit={updateJatoAviation}>
...
export default EditJatoAviation