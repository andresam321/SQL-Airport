...
const CreateBayRamp = ({isLoggedIn, setIsLoggedIn}) => {
    ...
    const submitHandler = (e) =>{
        e.preventDefault()
        axios.post('http://localhost:8000/api/bayRampArea', {
            locationOfPlane,
            area,
            tailNumber,
            airplaneType,
    ...
    <div className='display-flex3'>
        ...
        <div className="form-group row">
            ...
            <select value ={area} className="form-control" name="area" onChange={(e)=> setArea(e.target.value)}>
                <option>Area</option>
                <option value="Bay Ramp">Bay Ramp</option>
